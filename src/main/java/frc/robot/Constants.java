...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kFasterTeleMaxMetersPerSec = 10;
    public static final double kFasterTeleMaxRadiansPerSec = 5;
    public static final double kFastTeleMaxMetersPerSec = 5;
    public static final double kFastTeleMaxRadiansPerSec = 2;
    public static final double kTeleMaxMetersPerSec = 1;
    public static final double kTeleMaxRadiansPerSec = 1;
    public static final double kNudgeSpeed = 2;
